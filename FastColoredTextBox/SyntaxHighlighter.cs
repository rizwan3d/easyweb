...
namespace FastColoredTextBoxNS
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        public readonly Style BlueBoldStyle2 = new TextStyle(Brushes.Blue, null, FontStyle.Bold);
        public readonly Style BlueStyle2 = new TextStyle(Brushes.DodgerBlue, null, FontStyle.Regular);
        ...
        public readonly Style GrayStyle2 = new TextStyle(Brushes.Gray, null, FontStyle.Regular);
        public readonly Style GreenStyle2 = new TextStyle(Brushes.Gray, null, FontStyle.Italic);
        public readonly Style MagentaStyle2 = new TextStyle(Brushes.Crimson, null, FontStyle.Regular);
        public readonly Style MaroonStyle2 = new TextStyle(Brushes.Crimson, null, FontStyle.Regular);
        public readonly Style RedStyle2 = new TextStyle(Brushes.Tomato, null, FontStyle.Regular);
        public readonly Style BlackStyle2 = new TextStyle(Brushes.Black, null, FontStyle.Regular);
        ...
        protected Regex CSSAttrRegex,
              CSSAttrValRegex,
              CSSCommentRegex1,
              CSSCommentRegex2;

        protected Regex CSSEndTagRegex;

        protected Regex CSSEntityRegex,
                      CSSTagContentRegex;

        protected Regex CSSTagNameRegex;
        protected Regex CSSTagRegex;
        private Style cssEntityStyle;
        ...
        public virtual void AutoIndentNeeded(object sender, AutoIndentEventArgs args)
        {
            ...
            switch (language)
            {
                ...
                case Language.HTML:
                    ...
                    break;
                case Language.CSS:
                    CSSAutoIndentNeeded(sender, args);
                    break;
                case Language.XML:
        ...
        protected void CSSAutoIndentNeeded(object sender, AutoIndentEventArgs args)
        {
            var tb = sender as FastColoredTextBox;
            tb.CalcAutoIndentShiftByCodeFolding(sender, args);
        }
        ...
        public void InitStyleSchema(Language lang)
        {
            switch (lang)
            {
                ...
                case Language.VB:
                    ...
                    break;
                case Language.HTML:
                    CommentStyle = GreenStyle2;
                    TagBracketStyle = BlueStyle2;
                    TagNameStyle = MaroonStyle2;
                    AttributeStyle = RedStyle2;
                    AttributeValueStyle = BlueStyle2;
                    HtmlEntityStyle = RedStyle2;
                    break;
                case Language.CSS:
                    CommentStyle = GreenStyle2;
                    TagBracketStyle = BlueStyle2;
